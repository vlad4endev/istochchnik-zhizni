-- Add "minister" as a valid application role.
UPDATE public.members
SET app_role = 'member'
WHERE app_role IS NULL
   OR app_role NOT IN ('member', 'minister', 'pastor', 'musician', 'editor', 'admin');
...
ALTER TABLE public.members
  ...
  CHECK (app_role IN ('member', 'minister', 'pastor', 'musician', 'editor', 'admin'));
