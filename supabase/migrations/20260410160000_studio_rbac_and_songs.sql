-- Расширение ролей: musician, editor (модерация каталога), admin
...
-- Каталог песен (ChordPro и метаданные)
...
-- Личная версия (ветка) общей песни
...
-- Черновики без привязки к каталогу
...
-- Настройки инструментов (произвольный JSON)
