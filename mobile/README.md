...
- Главная, чаты + realtime (опросы, закрепления, реакции, фото, пересылка), молитва, песенник, проповеди
- Студия (сетлисты / reorder / perform, **редактор версий ChordPro**)
...
- Полные редакторы студии (блоки/ноты) и AI/импорт
- Admin / analytics
- WebRTC-звонки
- Полировка мессенджера (файлы / голосовые, права группы)
