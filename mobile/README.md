...
- Главная, чаты + realtime (опросы, закрепления, реакции, фото, файлы, голосовые, пересылка), молитва, песенник, проповеди
- Студия (сетлисты / reorder / perform, редактор версий ChordPro + AI)
...
- Полные редакторы студии (блоки/ноты) и расширенный AI/импорт
- Admin / analytics
- WebRTC-звонки
- Полировка мессенджера (права группы)
