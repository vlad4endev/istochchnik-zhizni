...
import { LuChevronLeft, LuChevronRight, LuChurch, LuListOrdered, LuMessageCircle, LuMic, LuShield, LuUser, LuWifiOff, LuX } from 'react-icons/lu';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/service-flow', label: 'План', Icon: LuListOrdered },
