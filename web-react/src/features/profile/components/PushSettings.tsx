      ...
      <div className={profileShell.profileRoot} data-profile-root>
        ...
        {isParishioner ? (
          <p className="mt-2 text-xs text-[color:var(--profile-text-faint)]">
            Для роли «прихожанин» приходят: чаты, трансляции, лента (лайки, комментарии, репосты),
            напоминание о молитве, дни рождения, новые проповеди и события. Служебные назначения
            координаторам не отправляются.
          </p>
        ) : null}
      </div>
    );
    ...
    <div className={`${profileShell.profileRoot} mt-0 border-0 pt-0`} data-profile-root>
      ...
      {isParishioner ? (
        <p className="mt-3 text-xs text-[color:var(--profile-text-faint)]">
          Роль «прихожанин»: чаты, трансляции, лента (лайки, комментарии, репосты), молитва, дни
          рождения, проповеди и события. Служебные назначения координаторам не приходят.
        </p>
      ) : null}
