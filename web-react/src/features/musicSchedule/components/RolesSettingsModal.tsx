...
export function RolesSettingsModal({
  ...
  const [ordered, setOrdered] = useState<MusicRole[]>(roles);
      ...
      >
        <div className="shrink-0 border-b border-stone-100 px-4 py-3">
          ...
          <div className="flex items-center justify-between gap-3">
            <h2 className="text-base font-extrabold text-stone-900">Роли музыкального служения</h2>
            <button
              type="button"
              onClick={onClose}
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-4 py-3">
          ...
          <DragDropContext onDragEnd={onDragEnd}>
            <Droppable droppableId="music-roles">
              {(provided) => (
