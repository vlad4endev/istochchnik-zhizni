...
const ASSISTANT_EXAMPLE_QUESTIONS: ReadonlyArray<{ label: string; text: string }> = [
  ...
  },
  {
    ...
    text: 'Что в молитвенном календаре на сегодня? Кто в цикле, какая тема и нужда?',
  },
  {
    label: 'История нужд',
  ...
  {
    label: 'Кто в молитвенном цикле?',
    text: 'Кто сейчас в молитвенном цикле и в каком порядке? Кто молится сегодня?',
  },
];
