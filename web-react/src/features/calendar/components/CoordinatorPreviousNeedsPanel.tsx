...
export function CoordinatorPreviousNeedsPanel(props: {
  ...
  return (
    <div className="rounded-lg border border-stone-200/90 bg-white/80 px-2 py-2">
      <p className="flex items-center gap-1 text-[11px] font-bold uppercase tracking-wide text-stone-600">
        <LuHistory className="h-3 w-3" aria-hidden />
        Предыдущие нужды
      </p>
      {items.length > 0 ? (
        ...
        <p className="mt-2 text-[12px] text-stone-400">Пока нет сохранённых предыдущих нужд.</p>
      )}
