...
export function AuthLandingPage() {
  ...
  if (!sessionReady) {
    return (
      <div className="flex h-full min-h-0 w-full max-w-[100vw] flex-1 items-center justify-center bg-primary text-white [min-height:var(--app-viewport-height,100dvh)] [max-height:var(--app-viewport-height,100dvh)]">
  ...
  return (
    <div className="flex h-full min-h-0 w-full max-w-[100vw] flex-1 flex-col overscroll-y-none bg-[#5c2830] bg-gradient-to-b from-primary via-primary to-[#5c2830] text-white [min-height:var(--app-viewport-height,100dvh)] [max-height:var(--app-viewport-height,100dvh)]">
