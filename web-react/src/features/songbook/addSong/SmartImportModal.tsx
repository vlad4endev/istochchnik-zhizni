        ...
        <div className="mb-4 flex items-start justify-between gap-3">
          <div>
            ...
            <p className={`mt-1.5 text-sm leading-relaxed ${muted}`}>
              Выберите источник: вставьте текст, загрузите PDF (текстовый слой) или укажите прямую ссылку на
              текстовый файл. Затем нажмите «Вставить в форму» — аккорды над строками будут приведены к ChordPro.
            </p>
          </div>
          <button
            type="button"
