...
/** Убирает из заметки строки служебных ключей и даты границ недели из content_json (если совпадают с полями). */
...
/** Текст заметки для отображения: без пустых меток и служебных строк планировщика. */
