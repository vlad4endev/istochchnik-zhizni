...
/**
 * Короткая ссылка редактирования: проверяем токен и открываем обычный планировщик
 * на конкретной программе, чтобы интерфейс был идентичен основному редактору.
 */
